...
const TaskModelSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'status_deadline': IndexSchema(
      id: 1735794883415591050,
      name: r'status_deadline',
      unique: false,
      replace: false,
      properties: [
        IndexPropertySchema(
...
void _taskModelSerialize(
  ...
  writer.writeBool(offsets[8], object.hasDeadline);
  ...
  writer.writeBool(offsets[12], object.isStarred);
...
TaskModel _taskModelDeserialize(
  ...
  final object = TaskModel(
    actualMinutes: reader.readLongOrNull(offsets[0]) ?? 0,
    ...
    deadline: reader.readDateTimeOrNull(offsets[5]),
    description: reader.readStringOrNull(offsets[6]) ?? '',
    estimatedMinutes: reader.readLongOrNull(offsets[7]) ?? 0,
    id: id,
    isArchived: reader.readBoolOrNull(offsets[9]) ?? false,
    isStarred: reader.readBoolOrNull(offsets[12]) ?? false,
    ...
    uuid: reader.readStringOrNull(offsets[24]) ?? '',
  );
  return object;
}
...
extension TaskModelQueryWhereSort
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhere> anyStatusDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'status_deadline'),
      );
    });
  }
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhere> anyIsStarred() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhere> anyIsArchived() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TaskModelQueryWhere
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause>
      statusEqualToAnyDeadline(TaskStatus status) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'status_deadline',
        value: [status],
      ));
    });
  }
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause>
      statusNotEqualToAnyDeadline(TaskStatus status) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause>
      statusEqualToDeadlineIsNull(TaskStatus status) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'status_deadline',
        value: [status, null],
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause>
      statusEqualToDeadlineIsNotNull(TaskStatus status) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'status_deadline',
        lower: [status, null],
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> statusDeadlineEqualTo(
      TaskStatus status, DateTime? deadline) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'status_deadline',
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause>
      statusEqualToDeadlineNotEqualTo(TaskStatus status, DateTime? deadline) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'status_deadline',
              lower: [status],
              upper: [status, deadline],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'status_deadline',
              lower: [status, deadline],
              includeLower: false,
              upper: [status],
            ));
      } else {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause>
      statusEqualToDeadlineGreaterThan(
    TaskStatus status,
    DateTime? deadline, {
    bool include = false,
  }) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'status_deadline',
        lower: [status, lowerDeadline],
        includeLower: includeLower,
        upper: [status, upperDeadline],
        includeUpper: includeUpper,
      ));
    });
  }
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> isStarredEqualTo(
      bool isStarred) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> isStarredNotEqualTo(
      bool isStarred) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> isArchivedEqualTo(
      bool isArchived) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> isArchivedNotEqualTo(
      bool isArchived) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> createdAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> createdAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'createdAt',
        lower: [null],
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> hasDeadlineEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hasDeadline',
        value: value,
      ));
    });
  }
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByHasDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasDeadline', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByHasDeadlineDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasDeadline', Sort.desc);
    });
  }
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByHasDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasDeadline', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByHasDeadlineDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasDeadline', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByHasDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'hasDeadline');
    });
  }
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByIsStarred() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, bool, QQueryOperations> hasDeadlineProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'hasDeadline');
    });
  }
  ...
  QueryBuilder<TaskModel, bool, QQueryOperations> isStarredProperty() {
    return QueryBuilder.apply(this, (query) {
