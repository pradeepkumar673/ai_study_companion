...
const PomodoroSessionModelSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'wasCompleted': IndexSchema(
      id: -1011157879898245096,
      name: r'wasCompleted',
      unique: false,
      replace: false,
      properties: [
    ...
    r'linkedTaskId': IndexSchema(
      id: -2020935108569735236,
      name: r'linkedTaskId',
      unique: false,
      replace: false,
      properties: [
...
PomodoroSessionModel _pomodoroSessionModelDeserialize(
  ...
  final object = PomodoroSessionModel(
    actualDurationSeconds: reader.readLongOrNull(offsets[0]) ?? 0,
    completedAt: reader.readDateTimeOrNull(offsets[1]),
    id: id,
    label: reader.readStringOrNull(offsets[2]) ?? '',
    linkedTaskId: reader.readStringOrNull(offsets[3]) ?? '',
...
extension PomodoroSessionModelQueryWhereSort
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel, QAfterWhere>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'wasCompleted'),
      );
    });
  }
}
...
extension PomodoroSessionModelQueryWhere
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel, QAfterWhereClause>
      wasCompletedEqualTo(bool wasCompleted) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'wasCompleted',
        value: [wasCompleted],
      ));
    });
  }
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel, QAfterWhereClause>
      wasCompletedNotEqualTo(bool wasCompleted) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel, QAfterWhereClause>
      linkedTaskIdEqualTo(String linkedTaskId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'linkedTaskId',
        value: [linkedTaskId],
      ));
    });
  }
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel, QAfterWhereClause>
      linkedTaskIdNotEqualTo(String linkedTaskId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension PomodoroSessionModelQueryFilter on QueryBuilder<PomodoroSessionModel,
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> linkedTaskIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> linkedTaskIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> linkedTaskIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> linkedTaskIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> linkedTaskIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> linkedTaskIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> linkedTaskIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'linkedTaskId',
        value: '',
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> linkedTaskIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'linkedTaskId',
        value: '',
  ...
  QueryBuilder<PomodoroSessionModel, PomodoroSessionModel,
      QAfterFilterCondition> wasCompletedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension PomodoroSessionModelQueryProperty on QueryBuilder<
  ...
  QueryBuilder<PomodoroSessionModel, String, QQueryOperations> labelProperty() {
    return QueryBuilder.apply(this, (query) {
