...
/// Reads [webStoreProvider] which is overridden at startup.
final taskRepositoryProvider = Provider<TaskRepository>((ref) {
  return TaskRepository(ref.read(webStoreProvider));
});
...
final noteRepositoryProvider = Provider<NoteRepository>((ref) {
  return NoteRepository(ref.read(webStoreProvider));
});
...
final focusRepositoryProvider = Provider<FocusRepository>((ref) {
  return FocusRepository(ref.read(webStoreProvider));
});
...
final subjectRepositoryProvider = Provider<SubjectRepository>((ref) {
  return SubjectRepository(ref.read(webStoreProvider));
});

final attendanceRepositoryProvider = Provider<AttendanceRepository>((ref) {
  return AttendanceRepository(ref.read(webStoreProvider));
});

final scheduleEventRepositoryProvider = Provider<ScheduleEventRepository>((ref) {
  return ScheduleEventRepository(ref.read(webStoreProvider));
});
...
final flashcardRepositoryProvider = Provider<FlashcardRepository>((ref) {
  return FlashcardRepository(ref.read(webStoreProvider));
});

final quizRepositoryProvider = Provider<QuizRepository>((ref) {
  return QuizRepository(ref.read(webStoreProvider));
});
...
final goalRepositoryProvider = Provider<GoalRepository>((ref) {
  return GoalRepository(ref.read(webStoreProvider));
});
...
final moodRepositoryProvider = Provider<MoodRepository>((ref) {
  return MoodRepository(ref.read(webStoreProvider));
});
...
final profileRepositoryProvider = Provider<ProfileRepository>((ref) {
  return ProfileRepository(ref.read(webStoreProvider));
});

final analyticsRepositoryProvider = Provider<AnalyticsRepository>((ref) {
  return AnalyticsRepository(ref.read(webStoreProvider));
});
...
/// here via [ProviderScope.overrides] ΓÇö same pattern as [webStoreProvider].
///
